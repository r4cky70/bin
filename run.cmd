...
IF [%2] == [] (
  g++ %1.cpp -std=c++14 -Wall -Wextra -Wfatal-errors -Wl,--stack=268435456 -Wno-sign-compare -o sla
) ELSE (   
  g++ %1.cpp -std=c++14 -Wall -Wextra -Wfatal-errors -Wl,--stack=268435456 -Wno-sign-compare -DLOCAL -o sla
)
